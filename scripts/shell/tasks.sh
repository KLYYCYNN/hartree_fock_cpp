...
INPUTS=(
    "examples/single_run/1_4_benzoquinone.json"
    "examples/single_run/catechol.json"
    "examples/single_run/benzoic_acid.json"
    "examples/single_run/benzothiophene.json"
)
